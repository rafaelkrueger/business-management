  ...
  useEffect(() => {
    if (activeCompany) {
      ...
      LandingPageService.getlandingPages(activeCompany)
        .then((res) => setLandingPages(res.data))
    ...
    <Box sx={{
      ...
      {/* Tabs */}
        <Box sx={{
          ...
          mb: 2,
          position: 'sticky',
          background: 'linear-gradient(to bottom, #4682D7 10%, #6192d4 40%, #669ee7 100%)',
          zIndex: 9,
          pt: 1,
          color:'white',
        }}>
          ...
          {loadingPages ? (
                ...
                >
                  {page.screenshotUrl ? (
                    ...
                    <Box sx={{
                      ...
                      backgroundColor: alpha('#4682D7', 0.1)
                    }}>
                      <InsertDriveFileOutlined sx={{ color: alpha('#4682D7', 0.5) }} />
                    </Box>
                  )}
                  ...
                  <Box sx={{
                    display: 'flex',
                    p: 1,
                    borderTop: `1px solid ${alpha('#4682D7', 0.1)}`
                  }}>
                    <Button
                      size="small"
            ...
            >
              ...
              <Button
                ...
                sx={{
                  backgroundColor: '#4682D7',
                  '&:hover': { backgroundColor: alpha('#4682D7', 0.9) }
                }}
              >
    ...
    <DialogActions>
      ...
      >
        {creatingLandingPage ? (
          ...
          t("marketing.previewDialog.createLandingPage")
        )}
      </Button>
